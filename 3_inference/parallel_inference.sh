...
foldertoanalyze='../outputs/Random_search_LUCAS/'
gt_path='../inputs/gt_LUCAS.csv'
name_files_test='test_set_local_lucas.csv'
...
cat Main-par.txt | parallel -k --linebuffer -j $JOBS {}